...
import * as Contacts from 'expo-contacts'; // 🔥 PRO FIX: Contacts Import Added
    ...
    try {
      ...
      if (status === 'granted') {
        ...
        Alert.alert(
          ...
          language === 'te' ? "యజమాని ఫోన్ నంబర్లను సులభంగా యాడ్ చేయడానికి పర్మిషన్ కావాలి. దయచేసి సెట్టింగ్స్ లోకి వెళ్లి 'Contacts' పర్మిషన్ ఆన్ చేయండి." : "Please enable Contacts permission in Settings to easily add owners.",
          [
