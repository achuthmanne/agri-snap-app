...
const grouped = Object.values(
  data.reduce<Record<string, { work: string; list: WorkItem[] }>>((acc, item) => {
    if (!acc[item.work]) acc[item.work] = { work: item.work, list: [] };
    acc[item.work].list.push(item);
    return acc;
  }, {})
);
    ...
    <View style={styles.cropCard}>
      ...
      <View style={{ flexDirection: "row", alignItems: "center", padding: 16 }}>
        <ShimmerPlaceHolder
          ...
          style={{ width: 4, height: 30, borderRadius: 4 }}
        />
        <ShimmerPlaceHolder
          LinearGradient={LinearGradient}
          style={{ width: 120, height: 14, marginLeft: 10, borderRadius: 6 }}
        />
      </View>
      ...
      <View style={{ padding: 14 }}>
        <ShimmerPlaceHolder
          LinearGradient={LinearGradient}
          style={{ width: "60%", height: 14, borderRadius: 6, marginBottom: 8 }}
        />

        <ShimmerPlaceHolder
          LinearGradient={LinearGradient}
          style={{ width: "90%", height: 12, borderRadius: 6, marginBottom: 6 }}
        />
        ...
        <ShimmerPlaceHolder
          LinearGradient={LinearGradient}
          style={{ width: "40%", height: 16, borderRadius: 6, marginTop: 10 }}
        />
      </View>
...
ListEmptyComponent={
  <View style={styles.emptyBox}>
    ...
    <AppText style={styles.emptySub}>
      {language === "te"
        ? "పనులను చేర్చడానికి + బటన్ నొక్కండి"
        : "Tap + button to add work"}
    </AppText>
...
>
  ...
  <View style={{
    ...
    height: 50,
    borderRadius: 4,
    backgroundColor: getCropColor(item.work),
    marginRight: 10
  }} />
 ...
 <View style={{ flex: 1 }}>
  ...
  <AppText style={styles.cropCount}>
    {language === "te"
      ? `${item.list.length} పనులు`
      : `${item.list.length} Works`}
  </AppText>
</View>
...
<View key={work.id} style={[styles.workCard, work.paymentStatus === "paid" && {
     opacity: 0.6,
  borderColor: "#16A34A"
}]}>
...
<View style={styles.statusRow}>
  ...
  styles.statusText,
  {
    color: work.paymentStatus === "paid" ? "#16A34A" : "#DC2626"
  }
]}>
 ...
 <TouchableOpacity
  ...
  disabled={work.paymentStatus === "paid"} // 🔥 MAIN FIX
  style={[
    styles.toggle,
    {
      backgroundColor: work.paymentStatus === "paid" ? "#16A34A" : "#DC2626",
      opacity: work.paymentStatus === "paid" ? 0.6 : 1 // visual feedback
    }
  ]}
  onPress={() => {
    if (work.paymentStatus === "paid") return; // 🔥 extra safety
...
>
  <View style={[
    styles.toggleCircle,
    {
      alignSelf: work.paymentStatus === "paid" ? "flex-end" : "flex-start"
    }
  ]} />
</TouchableOpacity>
</View>
  ...
  <View style={styles.detailsGrid}>
    ...
    <View style={styles.detailItem}>
      ...
      <AppText style={styles.label}>
        {language === "te" ? "మొత్తం:" : "Payable:"}
      </AppText>
      </View>
      <AppText style={styles.value}>
        ₹ {Number(work.payableAmount || 0).toLocaleString("en-IN")}
      </AppText>
    ...
    <View style={styles.detailItem}>
      ...
      <AppText style={styles.label}>
        {language === "te" ? "అడ్వాన్స్:" : "Advance:"}
      </AppText>
      </View>
      <AppText style={styles.value}>
        ₹ {Number(work.advanceAmount || 0).toLocaleString("en-IN")}
      </AppText>
      </View>
  ...
  <View style={styles.bottomRow}>
    ...
    <AppText style={styles.finalAmount}>
      ₹ {amount.toLocaleString("en-IN")}
    </AppText>

    <TouchableOpacity activeOpacity={0.7}
  style={styles.deleteBtn}
  onPress={() => setDeleteId(work.id)}
>
...
<Modal visible={!!deleteId} transparent animationType="fade">
  <View style={styles.overlay}>
    <View style={styles.modalBox}>
      ...
      <AppText style={styles.modalTitle}>
        {language === "te" ? "తొలగించాలా?" : "Delete Work?"}
      </AppText>

      <AppText style={styles.modalSub}>
        {language === "te"
          ? "ఈ పనిని తొలగించాలనుకుంటున్నారా?"
  ...
  <TouchableOpacity activeOpacity={0.8}
    style={styles.deleteConfirmBtn1}
...
notesBox: {
  flexDirection: "row",
  alignItems: "flex-start", // 🔥 important (top align)
  gap: 6,
  marginTop: 10,
  paddingTop: 10,
  borderTopWidth: 1,
...
notesText: {
  ...
  color: "#374151",
  flex: 1,
  lineHeight: 18 // 🔥 important for alignment
},
workCard: {
  padding: 14,
  borderTopWidth: 1,
